  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    .and()
      .authorizeRequests()
        ...
        .antMatchers("/fornecedor/**").hasRole("MANTER_FORNECEDOR")
        .antMatchers("/pdv/**").hasRole("MANTER_PDV")
        .antMatchers("/movimentacao-caixa/**").hasRole("MOVIMENTACAO_CAIXA")
        .antMatchers("/movimentacao-caixa/usuarios").hasRole("FILTRAR_POR_USUARIO_MOVIMENTACAO_CAIXA")
        .antMatchers("/mensagem/**").hasRole("LER_MENSAGENS")
        .antMatchers("/clienteSistema/**").hasRole("SUPER_USER")
        .antMatchers("/usuario/salvar").hasRole("MANTER_USUARIO")
        .antMatchers("/usuario/pesquisar").hasRole("MANTER_USUARIO")
        .antMatchers("/estoque/**").hasRole("CONFERIR_ESTOQUE")
        .antMatchers("/").hasRole("DASHBOARD")
