...
VALUES (true,'Jardim Curitiba','61650005','Goiânia','77835168000141','2021-08-05 00:10:19.887','2021-08-05 00:10:19.887','Goiás','Quandra 45 lote 3','Loja sud',true,3,'sud');
...
INSERT INTO usuario (id,nome, email, senha,proprietario, ativo, tenant) VALUES (3,'SUD', 'sud@storedrink.com', '$2a$10$rODOzMz60JmUUx5J39p9JOb5Ee7c2303YeH0kp42XJOW7Ch9qcBy2',false, true, (SELECT tenant FROM cliente_sistema WHERE tenant = 'sud'));
...
INSERT INTO cliente_sistema(acessar_tela_criar_login, bairro, cep, cidade, cpf_cnpj, data_atualizacao, data_cadastro, estado, logradouro, nome_comercio, primeiro_acesso, qtd_usuario, tenant)
VALUES (true,'Setor bueno','61650005','Goiânia','77835168009890','2021-08-05 00:10:19.887','2021-08-05 00:10:19.887','Goiás','Quandra 45 lote 3','Loja VFS',true,2,'sbn');
